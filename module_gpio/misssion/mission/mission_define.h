...
class if_else_step{
    public:
        ...
        int set_id(int n);
        //
        multiple_step_II * condition_step;
        multiple_step_II * if_step;
        multiple_step_II * else_step;
};
class try_catch_step{
    public:
        string data;
        ...
        int num_tab;
        //
        multiple_step_II * try_step;
        multiple_step_II * catch_step;
};
class normal_step{
    public:
        string data;
...
class logic_and_step{
    public:
        ...
        int status_B;
        //
        multiple_step_II * logic_A;
        multiple_step_II * logic_B;
};
class logic_or_step{
    public:
        string data;
...
class step_II{
    public:
        ...
        int set_id(int n);
        // action step
        if_else_step*        my_if_else_step;
        try_catch_step*      my_try_catch_step;
        normal_step*         my_normal_step;
        multiple_step_I*     my_smallest_step;
        while_step*          my_while_step;
        // logic step
        logic_and_step*      my_logic_and_step;
        logic_or_step*       my_logic_or_step;
...
class mission{
    public:
        ...
        //
        int id_mission=0;
        multiple_step_II*    my_multiple_step_II;
        multiple_step_I*     my_configuration; 
        //
        void process_data();
        void print(int n);
        int action(int action);
...
string gpio_msg;
vector<uint8_t>  	input_user_status;
vector<uint8_t>  	input_user_status_1;
vector<uint8_t>   	input_user_status_2;
vector<uint8_t>   	output_user_status;
// infor mission
...
class moudle_ {
    public:
        string name;
        vector<uint8_t>  input_user;
        vector<uint8_t>  input_user1;
        vector<uint8_t>  input_user2;
        vector<uint8_t>  output_user;
};
