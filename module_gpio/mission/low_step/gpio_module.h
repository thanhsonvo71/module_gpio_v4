    ...
    if(action==Active_){
        ...
        if(num_module!=-1){
            ...
            if(out_set!="" || out_reset!=""){
                if(out_set!="") {
                    ...
                    for(int i=0;i<data.size();i++){
                        if(data[i]<my_module[num_module].output_user.size()){
                            if(my_module[num_module].output_user[data[i]]!=1){
                                value_return=action;
                ...
                if(out_reset!=""){
                    ...
                    for(int i=0;i<data.size();i++){
                        if(data[i]<my_module[num_module].output_user.size()){
                            if(my_module[num_module].output_user[data[i]]!=0){
                                value_return=action;
            ...
            if(in_on!="") {
                ...
                for(int i=0;i<data.size();i++){
                    if(data[i]<my_module[num_module].input_user.size()){
                        if(my_module[num_module].input_user[data[i]]!=1) value_return=action;
                        else{
            ...
            if(in_off!="") {
                ...
                for(int i=0;i<data.size();i++){
                    if(data[i]<my_module[num_module].input_user.size()){
                        if(my_module[num_module].input_user[data[i]]!=0) value_return=action;
                        else{
            ...
            if(in_pullup!="") {
                ...
                for(int i=0;i<data.size();i++){
                    if(data[i]<my_module[num_module].input_user1.size() && data[i]<my_module[num_module].input_user2.size()){
                        if(my_module[num_module].input_user1[data[i]]==1 && my_module[num_module].input_user2[data[i]]==0 ){            
                            is_have=0;
            ...
            if(in_pulldown!="") {
                ...
                for(int i=0;i<data.size();i++){
                    if(data[i]<my_module[num_module].input_user1.size() && data[i]<my_module[num_module].input_user2.size()){
                        if(my_module[num_module].input_user1[data[i]]==0 && my_module[num_module].input_user2[data[i]]==1 ){            
                            is_have=0;
